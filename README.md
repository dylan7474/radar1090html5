...
- Optional aircraft label overlay toggled from the sidebar to display callsigns, altitude, and inbound distance/ETA around each blip, now with automatic collision avoidance that repositions overlapping tags and draws connector lines back to their aircraft.

...
- Optional aircraft label overlay toggled from the sidebar to display callsigns around each blip, presented in compact callout panels with collision avoidance, dynamic font sizing, steady brightness between sweeps, stabilized placement to prevent jitter, and connector lines back to their aircraft when repositioned.
